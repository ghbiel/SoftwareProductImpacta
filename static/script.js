...
window.addEventListener("load", function () {
    if (localStorage.getItem("consultaAgendada")) {
        mostrarToast();

        // Remove a flag para que o toast não apareça novamente no próximo reload
        localStorage.removeItem("consultaAgendada");
    }
});

function checkAvailability(id, rota, metodo, data, hora, nomeAnimal, especieAnimal, racaAnimal, tipoConsulta, nomeTutor, emailTutor, telefoneTutor) {
...
function submitForm(id, rota, metodo, nomeAnimal, especieAnimal, racaAnimal, tipoConsulta, nomeTutor, emailTutor, telefoneTutor, data, hora) {
    ...
    fetch(rota, {
        ...
        .then(data => {
            if (data.success) {
                localStorage.setItem("consultaAgendada", "true");
